...
mcu_walker::mcu_walker(float cpu_speed, int memory, string os, string name, int volt, int motor_speed, int rotation) 
    : MCU(cpu_speed, memory, os, name, volt), motor_speed(motor_speed), rotation(rotation)
    {   
